...
//Update
float update_adt7420 ();


//Getters
uint16_t get_raw_adt7420 ();

float get_temp_adt7420 ();

uint32_t get_timestamp_adt7420 ();

int32_t cc1120_get_temp(int8_t *temperature, uint32_t timeout_ms);

/* int32_t stm32_get_temp(ADC_HandleTypeDef *h, float *temperature);

ADC_HandleTypeDef is not defined here HAL_Definition errors
*/
