/*----------------------------------------------------------------------------*-
   ...
   ttrd2-05a-t0401a-v001a_reg_conf_chk_adc1.h (Release 2017-03-06a)

  ----------------------------------------------------------------------------
   
   - See ttrd2-05a-t0401a-v001a_reg_conf_chk_adc1.c for details.
...
#ifndef _ADC1_CHECKS_H
#define _ADC1_CHECKS_H 1
