...
/**
  ...
  * @retval Error status for handling and debugging.
  */
EPS_soft_error_status EPS_update_state(volatile EPS_State *state, uint8_t  *hadc_eps, uint8_t  *h_i2c) {
...
/**
  ...
  * @retval Error status for handling and debugging.
  */
static EPS_soft_error_status EPS_update_state_adc_measurements(volatile EPS_State *state, uint8_t  *hadc_eps){
...
/**
  ...
  */
int16_t get_batterypack_temperature(uint8_t  *h_i2c, uint8_t sensor_A_i2c_address, uint8_t sensor_B_i2c_address,volatile EPS_State *state){
