/*----------------------------------------------------------------------------*-
   ...
   ttrd2-05a-t0401a-v001a_reg_conf_chk_uart.h (Release 2017-03-06a)

  ----------------------------------------------------------------------------
   
   - See ttrd2-05a-t0401a-v001a_reg_conf_chk_uart.c for details.
...
#ifndef _UART_CHECKS_H
#define _UART_CHECKS_H 1
