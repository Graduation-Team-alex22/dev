...
#include "../tasks/ADCS_exHealth_Rep_task.h"
#include "../tasks/COMMS_exHealth_Rep_task.h"
#include "../tasks/COMMS_Health_Rep_task.h"
#include "../tasks/COMMS_WOD_Rep_task.h"
#include "../tasks/EPS_exHealth_Rep_task.h"
#include "../tasks/EPS_Health_Rep_task.h"
#include "../tasks/IDLE_task.h"
#include "../tasks/COMMS_EXT_WOD_Rep_task.h"
#include "../tasks/SCHEDULE_SERVICES_task.h"
#include "../tasks/ADC1_task.h"
   ...
   switch (Processor_MoSt_g)
      ...
      case NORMAL_M:
         ...
         PROCESSOR_TASK_Init();
				 ...
				 EPS_Health_Rep_task_Init();
				 
				 SCHEDULE_SERVICES_Init();
         ...
         SCH_Add_Task(HEARTBEAT_SW_Update,   0,  100, 7,  6);    // Heartbeat
        // SCH_Add_Task(SWITCH_BUTTON1_Update, 10, 2,   8,  7);    // Switch
         SCH_Add_Task(ADC1_Update,           0,  50, 36, 35);   // ADC1
         SCH_Add_Task(PROCESSOR_TASK_Update, 0,  100, 17, 2);    // Proc task   
         //SCH_Add_Task(UART2_BUF_O_Update,    0,  1,   212, 104); // UART2

         SCH_Add_Task(EPS_Health_Rep_task_Update, 1,  20,  20000,   2);    // EPS_Health_Req
         SCH_Add_Task(COMMS_Health_Rep_task_Update, 2,  20,  20000,   2);    // COMMS_Health_Req
         SCH_Add_Task(COMMS_WOD_Rep_task_Update, 3,  20,  20000,   2);    // COMMS_WOD_Rep
         SCH_Add_Task(EPS_exHealth_Rep_task_Update, 4,  20,  20000,   2);    // EPS_exHealth_Req
         SCH_Add_Task(ADCS_exHealth_Rep_task_Update, 5,  20,  20000,   2);    // ADCS_exHealth_Req
         SCH_Add_Task(COMMS_exHealth_Rep_task_Update, 6,  20,  20000,   2);    // COMMS_exHealth_Req
         SCH_Add_Task(COMMS_EXT_WOD_Rep_task_Update, 7,  20,  20000,   2);    // COMMS_EXT_WOD_Rep
         SCH_Add_Task(IDLE_Update, 1,  100,  20000,   2);    // IDLE
         SCH_Add_Task(SCHEDULE_SERVICES_Update, 2,  100,  20000,   2);    // SCH-SE
         SCH_Add_Task(ADC1_vbat_Update, 5,  20,  20000,   2);    // ADCvbat
         SCH_Add_Task(UART_Update, 0,  1,  20000,   2);    // OBC_UART				 
