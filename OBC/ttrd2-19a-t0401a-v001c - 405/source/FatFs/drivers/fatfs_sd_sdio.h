...
//added
extern SD_Error SD_ReadBlock_Polling (uint32_t *pReadBuffer, uint64_t ReadAddr, uint32_t BlockSize, uint32_t NumberOfBlocks);
...
//added
extern SD_Error SD_WriteBlock_Polling (uint32_t *pWriteBuffer, uint64_t WriteAddr, uint32_t BlockSize, uint32_t NumberOfBlocks);
