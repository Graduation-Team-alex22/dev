...
#define C_ASSERT(e)    ((e) ? (true) : (tst_debugging(__FILE_ID__,(uint8_t *)__FILE__, __LINE__, #e)))
...
extern void send_packet(TC_TM_app_id app_id, uint8_t *buf, uint16_t size);
...
uint8_t tst_debugging(uint16_t fi,uint8_t* file, uint32_t l, char *e);
