...
extern SAT_returnState recieve_packet(TC_TM_app_id app_id, struct uart_data *data);

extern SAT_returnState UART_rx(TC_TM_app_id app_id, struct uart_data *data);

extern void UART_DMA_rx_check(TC_TM_app_id app_id, struct uart_data *data);
...
SAT_returnState import_pkt(TC_TM_app_id app_id, struct uart_data *data) {
   ...
   SAT_returnState res_deframe;
	 ...
	 res = recieve_packet(app_id,data);   	
