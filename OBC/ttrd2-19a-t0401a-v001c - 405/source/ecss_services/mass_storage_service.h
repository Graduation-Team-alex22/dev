...
SAT_returnState mass_storage_init(void);
...
SAT_returnState mass_storage_FATFS_RESET(void);

SAT_returnState mass_storage_FORMAT(void);

SAT_returnState mass_storage_dirCheck(void);
