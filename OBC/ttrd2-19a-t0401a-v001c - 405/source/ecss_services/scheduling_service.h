...
#define MIN_VALID_QB50_SECS 300
...
SAT_returnState cross_schedules(void);

SAT_returnState scheduling_service_init(void);

SAT_returnState scheduling_app(tc_tm_pkt* spacket);

SAT_returnState scheduling_state_api(void);
...
SAT_returnState operations_scheduling_reset_schedule_api(void);
...
SAT_returnState scheduling_service_save_schedules(void);
