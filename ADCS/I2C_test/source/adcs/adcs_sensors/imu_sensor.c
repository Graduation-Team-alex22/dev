...
uint32_t IMU_Sensor_Init(I2C_TypeDef* I2Cx)
{
   ...
   error_code = I2Cx_Is_Device_Connected(I2Cx, device_address, IMU_REG_WHOIAM, IMU_WHOIAM_VAL, IMU_I2C_EVENT_WAIT);
...
uint32_t IMU_Sensor_Update(I2C_TypeDef* I2Cx)
{
   ...
   /**************** Read Accel ****************/
   error_code = I2Cx_Recv_Bytes(I2Cx, device_address, IMU_REG_ACCEL_DATA, data, 6, IMU_I2C_EVENT_WAIT);
   ...
   /***************** Read Gyro ****************/
   error_code = I2Cx_Recv_Bytes(I2Cx, device_address, IMU_REG_GYRO_DATA, data, 6, IMU_I2C_EVENT_WAIT);
...
uint8_t	IMU_Wakeup(I2C_TypeDef* I2Cx)
{
   ...
   /************ reset the device ************/
   data = IMU_RESET;
   error_code = I2Cx_Send_Bytes(I2Cx, device_address, IMU_REG_PWR_MGMT_1, &data, 1, IMU_I2C_EVENT_WAIT);
...
uint8_t	IMU_Configure(I2C_TypeDef* I2Cx)
{
   ...
   error_code = I2Cx_Send_Bytes(I2Cx, device_address, IMU_REG_INT_PIN_CFG, &data, 1, IMU_I2C_EVENT_WAIT);
   if(error_code){return error_code;}
...
uint8_t IMU_Mag_Calib(I2C_TypeDef* I2Cx, float* calib)
{
   ...
   data[0] = 0x00;
   error_code = I2Cx_Send_Bytes(I2Cx, IMU_AKM_ADD, IMU_REG_MAG_CTRL, data, 1, IMU_I2C_EVENT_WAIT);
   if(error_code){return error_code;}
   ...
   error_code = I2Cx_Recv_Bytes(I2Cx, IMU_AKM_ADD, IMU_REG_MAG_ASAX, data, 3, IMU_I2C_EVENT_WAIT);
   if(error_code){ return error_code;}
