...
void PROCESSOR_Configure_Reqd_MoSt(void)
   ...
   switch (Processor_MoSt_g)
      ...
      case NORMAL_M:
         ...
         SCH_Add_Task(DUMMY_TASK_Update, 1,  100);    // OBC Comm       
         SCH_Add_Task(DUMMY_TASK_Update, 5,  20);    // IMU      
         SCH_Add_Task(DUMMY_TASK_Update, 10,  20);    // mgn      
         SCH_Add_Task(DUMMY_TASK_Update, 15,  20);    // tmp 
         SCH_Add_Task(DUMMY_TASK_Update, 20,  20);    // GPS
         SCH_Add_Task(DUMMY_TASK_Update, 25,  20);    // sun sensor
         SCH_Add_Task(DUMMY_TASK_Update, 30,  20);    // health check
         SCH_Add_Task(DUMMY_TASK_Update, 35,  20);    // time
         SCH_Add_Task(DUMMY_TASK_Update, 40,  20);    // tle
         SCH_Add_Task(DUMMY_TASK_Update, 45,  20);    // sgp4
         SCH_Add_Task(DUMMY_TASK_Update, 50,  20);    // ref verctors
         SCH_Add_Task(DUMMY_TASK_Update, 55,  20);    // attitude determination
         SCH_Add_Task(DUMMY_TASK_Update, 60,  20);    // control update
         SCH_Add_Task(DUMMY_TASK_Update, 65,  20);    // Actuators
