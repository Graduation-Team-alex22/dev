...
// The scheduler is instrumented in this design
// We can control the data recording / reporting here
// Note: cannot measure ET and jitter at the same time
// Note: can opt to measure *neither* ET nor jitter
#define MEASURE_TASK_ET_AND_CPU_LOAD (1)
#define MEASURE_TICK_JITTER (0)

// Interval (in scheduler ticks)
#define MEASURE_REPORTING_INTERVAL (2500)

// Set this to 0 to accumulate data over a long system run
#define RESTART_DATA_MEASUREMENT_AFTER_REPORTING (0)
...
// Processor module
#include "../processor/ttrd2-a07a-t0401a-v001b_processor.h"

// Scheduler module
#include "../scheduler/ttrd2-a07a-t0401a-v001a_instrumented_scheduler.h"
...
#define PFC_UNSPECIFIED_FAULT                                 ((uint8_t) 255)
